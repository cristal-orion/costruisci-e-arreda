  ...
  for (const stato of ['riposo', 'puntata']) {
    ...
    for (const w of LARGHEZZE) {
      ...
      await page.addStyleTag({ content: `
        .parete__campata::before { display: none !important; }
        .parete__campata::after {
          background: linear-gradient(to top, rgb(0 0 0 / 80%) 0%, rgb(0 0 0 / 52%) 42%, rgb(0 0 0 / 14%) 100%) !important;
          transition: opacity 200ms linear !important;
        }
        .parete__campata:hover::after, .parete__campata:focus-visible::after { opacity: 0.7 !important; }
      ` });
